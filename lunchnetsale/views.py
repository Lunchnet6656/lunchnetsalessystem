...
def download_csv_allreport(request):
    ...
    # CSVヘッダーを書き込み
    writer.writerow(['日付', '販売場所','販売場所NO','担当者','天気','体感気温','持参数','販売数','残数','その他項目1','その他1単価','その他1販売数',
                        'その他項目2','その他2単価','その他2販売数','その他売上合計','総売上','ご飯なし','ご飯追加','クーポン600','クーポン700','割引・返金50円','割引・返金100円','サービス名',
                        'サービス価格','割引合計','PayPay','電子決済','現金','差額','出発時間','到着時間','開店時間','完売時間','閉店時間','ガソリン代','高速代','駐車場代','パート代','その他経費',
                        'コメント','明日の食数設定'])
